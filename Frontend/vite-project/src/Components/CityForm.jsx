    ...
    return (
        <div className="search-form-div">
            <form className="search-form" onSubmit={(e) => apiMethod(cityData, e)}>
                ...
                <input className="search-form-input" value={cityData.longitude} type="decimal" onChange={(e) => setCityData(prev => ({ ...prev, longitude: e.target.value }))} />
                <label className="search-form-label"> Latitude </label>
                <input className="search-form-input" value={cityData.latitude} type="decimal" onChange={(e) => setCityData(prev => ({ ...prev, latitude: e.target.value }))} />
